  ...
  <div class="sql">
    <el-form ref="form" :model="form" label-width="180px">
      ...
      >
        ...
        <!-- <el-input v-model="form[item.name]" :validate-event="false" :disabled="item.name=='cepRule'?true:false" v-show="item.name!='cepRule'"></el-input> -->
        <!-- <el-input v-model="form[item.name]" :validate-event="false" :disabled="item.name=='cepRule'?true:false"></el-input> -->
        <el-button @click="showCepConfigDilog">配置</el-button>
      </el-form-item>
    </el-form>
