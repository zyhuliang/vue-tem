<template>
  <el-container class="newjobDescription" id="content">
    <el-header>
      <el-row type="flex" class="row-bg" justify="end" align="middle" :gutter="2">
        <el-col :span="7" justify="start" :offset="3" style="text-align: left">
        ...
        <el-col :span="14" style="text-align: right">
          ...
          <el-button type="info" :disabled="!this.flowName" id="designSubmit" @click="designSubmit"><i class="icon iconfont icon-ir-ok"></i>&nbsp;提交</el-button>
          <el-button type="info" @click="designSchedule" id="designSchedule"><i class="icon iconfont icon-ir-add"></i>&nbsp;调度</el-button>
          <el-button type="info" @click="reset" id="designDelSave"><i class="fa fa-eraser"></i>&nbsp;清空</el-button>
          <el-button type="info" id="designAll" @click="Screen">
...
import nodeSetWorkflow from "@design/designDraw/nodeSetWorkflow.vue";
...
import {stepsFilterObj,lStepsFilterObj,displayProp} from "@function/designFunction.js";             //引入design专用函数
...
export default {
  ...
  methods: {
    ...
    modifynodeSet(val) {
      //console.log('modifynodeSet(val){',val);
    ...
    isOpenStepDialog(val) {
      if (this.filterLinks(val).length == 2) {
        return true;
      }
    },
