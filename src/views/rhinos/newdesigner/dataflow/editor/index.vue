<template>
  <el-container class="newjobDescription" id="content">
    <el-header>
      <el-row type="flex" style="" class="row-bg" justify="end" align="middle" :gutter="10">
        <el-col :span="10" justify="end" :offset="3">
...
import nodeSetDataflow from "@design/designDraw/nodeSetDataflow.vue";
...
export default {
  ...
  mounted() {
    ...
    // this.flowNodeTypes = comp[this.$route.query.type];
  },
  beforeCreate() {},
  created() {},
  beforeMount() {},
  ...
  methods: {
    ...
    nodedblClick(val) {
      console.log("nodedblClick(val) {", val);
    ...
    designSet() {
      ...
      _this.flowSet.flowData = {
        inputs: _this.flowDataObj.inputs
          ? transformArr(deepCopy(_this.flowDataObj.inputs))
          : [],
        parameters: _this.flowDataObj.parameters || [],
        outputs: _this.flowDataObj.outputs
          ? transformArr(deepCopy(_this.flowDataObj.outputs))
          : [],
        dependencies: _this.flowDataObj.dependencies
          ? transformArr(deepCopy(_this.flowDataObj.dependencies))
          : []
      };
