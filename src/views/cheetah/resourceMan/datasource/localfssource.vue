    ...
    <section class="add-resource " id='bm-ch-resMan-httpsource-tmp'>
        <div class="res-data" v-loading="loading">
            <el-row class="btnClass">
                <div class="btn-left">
                    <h4>{{isNew ? '新建 ' : '编辑 '}}{{'LOCALFS' | cn}}数据源</h4>
                </div>
            </el-row>
            <el-form id="bm-ch-resourceMan-httpsource-form" :model="entity" ref="entity" :rules="rules"
                ...
                <el-form-item label="path" :label-width="formLabelWidth" prop="attributes.path">
                    <el-input name="bm-ch-resourceMan-httpsource-attributes-path-input"
                              v-model="entity.attributes.path" auto-complete="off" class="input-form"
                              :placeholder="'目录'"></el-input>
                </el-form-item>

                <el-form-item label="encoder" :label-width="formLabelWidth" prop="attributes.encoder">
                    <el-select name="bm-ch-resourceMan-httpsource-attributes-encoder-select"
                               v-model="entity.attributes.encoder">
                        <el-option
