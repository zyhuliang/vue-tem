<template>
    <section class="con-module" id="bm-hippo-monitor-ready">
        <el-row class="btnClass">
            <div class="btnLeft">
                <el-input id="bm-hippo-monitor-ready-searchInput" placeholder="请输入名称" v-model="searchInput"
                ...
                <div class="flowtype">
                    <h4>流程类型</h4>
                    <el-select id="bm-hippo-monitor-ready-flowType" v-model="flowType" placeholder="all"
            ...
            <div class="btn-right">
                <el-button id="bm-hippo-monitor-ready-del" type="info" @click="del"
                           :disabled="multipleSelection.length == 0"><i
                        class="icon iconfont icon-ir-directory-delete"></i>删除
                </el-button>
                <el-button id="bm-hippo-monitor-ready-refresh" type="info" @click="refresh"><i
                        class="icon iconfont icon-ir-operation"></i>刷新
                </el-button>
            </div>
        </el-row>
        <el-table
                id="bm-hippo-monitor-ready-table"
                :data="table.content"
                tooltip-effect="dark"
                style="width: 100%;"
        ...
        <el-pagination
                id="bm-hippo-monitor-ready-del-page"
    ...
    export default {
        ...
        methods: {
            ...
            buildParameters: function () {
                ...
                var parameter = createParameter('statusType', 'READY', 'EQUAL').Limit(limit).Offset(offset).Sort(field, orderDirection).Build();
                if (query != '%') {
