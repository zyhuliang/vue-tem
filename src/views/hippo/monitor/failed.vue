<template>
    <section class="con-module" id="bm-hippo-monitor-failed">
        <el-row class="btnClass">
            <div class="btnLeft">
                <el-input id="bm-hippo-monitor-searchInput" placeholder="请输入名称" v-model="searchInput"
                          @keyup.enter.native="searchKeyup" class="input-with-search">
                    <el-button id="bm-hippo-monitor-searchInput-value" slot="append" @click="searchTable"
                               icon="icon iconfont icon-ir-search"></el-button>
                </el-input>
                <el-date-picker
                        id="bm-hippo-monitor-timepicker"
                        v-model="dateValue"
                        type="daterange"
                ...
                <div class="flowtype">
                    <h4>流程类型</h4>
                    <el-select id="bm-hippo-monitor-flowType" v-model="flowType" placeholder="all"
            ...
            <div class="btn-right">
                <el-button type="info" id="bm-hippo-monitor-failed-del" @click="del"
                           :disabled="multipleSelection.length == 0"><i
                        class="icon iconfont icon-ir-directory-delete"></i>删除
                </el-button>
                <el-button type="info" id="bm-hippo-monitor-failed-refresh" @click="refresh"><i
                        class="icon iconfont icon-ir-operation"></i>刷新
                </el-button>
            </div>
        </el-row>
        <el-table
                id="bm-hippo-monitor-table"
                :data="table.content"
                tooltip-effect="dark"
                style="width: 100%"
        ...
        <el-pagination
                id="bm-hippo-monitor-pagination"
    ...
    export default {
        ...
        methods: {
            ...
            buildParameters: function () {
                ...
                var parameter = createParameter('statusType', 'FAILED', 'EQUAL').Limit(limit).Offset(offset).Sort(field, orderDirection).Build();
                if (query != '%') {
