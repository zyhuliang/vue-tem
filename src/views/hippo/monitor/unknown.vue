<template>
    <section class="con-module" id="bm-hippo-monitor-unknow">
        <el-row class="btnClass">
            <div class="btnLeft">
                <el-input id="bm-hippo-monitor-success-searchTable" placeholder="请输入名称" v-model="searchInput"
                          @keyup.enter.native="searchKeyup" class="input-with-search">
                    <el-button id="bm-hippo-monitor-success-searchTable-btn" slot="append" @click="searchTable"
            ...
            <div class="btn-right">
                <el-button id="bm-hippo-monitor-success-del" type="info" :disabled="multipleSelection.length == 0"><i
                        class="icon iconfont icon-ir-directory-delete"></i>删除
                </el-button>
                <el-button id="bm-hippo-monitor-success-refresh" type="info" @click="refresh"><i
                        class="icon iconfont icon-ir-operation"></i>刷新
                </el-button>
            </div>
        </el-row>
        <el-table
                id="bm-hippo-monitor-success-table"
                v-loading="loading"
                :data="table.content"
                tooltip-effect="dark"
                style="width: 100%;"
        ...
        <el-pagination
                id="bm-hippo-monitor-success-page"
    ...
    export default {
        ...
        methods: {
            ...
            buildParameters: function () {
                ...
                var parameter = createParameter('statusType', 'UNKNOWN', 'EQUAL').Limit(limit).Offset(offset).Sort(field, orderDirection).Build();
                if (query != '%') {
