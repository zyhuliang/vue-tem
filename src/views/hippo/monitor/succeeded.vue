<template>
    <section class="con-module" id="bm-hippo-monitor-success">
        <el-row class="btnClass">
            ...
            <div class="btn-right">
                <el-button id="bm-hippo-monitor-success-del" type="info" @click="del"
                           :disabled="multipleSelection.length == 0"><i
                        class="icon iconfont icon-ir-directory-delete"></i>删除
                </el-button>
                <el-button id="bm-hippo-monitor-success-refresh" type="info" @click="refresh1"><i
