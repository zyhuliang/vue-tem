<template>
    <section class="con-module" id="bm-hippo-monitor-timeout">
        <el-row class="btnClass">
            <div class="btnLeft">
                <el-input id="bm-hippo-monitor-timeout-searchTable" placeholder="请输入名称" v-model="searchInput"
                ...
                <div class="flowtype">
                    <h4>流程类型</h4>
                    <el-select id="bm-hippo-monitor-timeout-flowType" v-model="flowType" placeholder="all"
            ...
            <div class="btn-right">
                <el-button id="bm-hippo-monitor-timeout-del" type="info" @click="del"
                           :disabled="multipleSelection.length == 0"><i
                        class="icon iconfont icon-ir-directory-delete"></i>删除
                </el-button>
                <el-button id="bm-hippo-monitor-timeout-refresh" type="info" @click="refresh1"><i
        ...
        <el-table
                id="bm-hippo-monitor-timeout-table"
                :data="table.content"
                tooltip-effect="dark"
        ...
        <el-pagination
                id="bm-hippo-monitor-timeout-page"
    ...
    export default {
        ...
        methods: {
            ...
            buildParameters: function () {
                ...
                var parameter = createParameter('statusType', 'TIMEOUT', 'EQUAL').Limit(limit).Offset(offset).Sort(field, orderDirection).Build();
                if (query != '%') {
        ...
        beforeDestroy() {
            ...
            if (sessionStorage.getItem("checkArray")) {
                sessionStorage.removeItem("checkArray")
            }
        },
    }
</script>
