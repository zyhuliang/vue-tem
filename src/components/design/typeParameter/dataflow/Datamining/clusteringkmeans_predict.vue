...
<template>
    <div class="stepTable">
        <el-form  ref="nodeSetData" :model="nodeSetData" label-width="150px">
            ...
            <el-form-item :label="'clusterIdColumn'| cn">
                <el-tooltip  class="item" effect="dark" content="clusterIdColumn">
                    <i class="parIcon el-icon-warning"></i>
                </el-tooltip>
                <el-input :value="nodeData.clusterIdColumn" name="clusterIdColumn" placeholder="clusterIdColumn（必填）" @input="clusterIdColumnVal"></el-input>
            </el-form-item>
            <i class="sign" v-if="nodeData.clusterIdColumn ==''">{{'clusterIdColumn'| cn}}不能为空</i>
        </el-form>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // labelColumn 绑定获取值
            clusterIdColumnVal:function (val) {
                this.nodeData.clusterIdColumn = val
            },
