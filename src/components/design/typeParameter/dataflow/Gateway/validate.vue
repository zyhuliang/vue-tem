                ...
                <el-form id="bm-nodeset-validate-form" ref="nodeSetData" :model="nodeSetData" label-width="150px">
                        <el-form-item :label="'validationRules'| cn">
                                ...
                                <div v-for="(vr,key1,index) in nodeData.validationRules" :key="key1">
                                        <el-input :value="vr.name" placeholder="名称（必填）" @input="(value) => vrNameVal(value, key1)" name="vrNameVal"></el-input>
                        ...
                        <el-form-item label="detailColumn">
                                ...
                                <el-input :value="nodeData.detailColumn" placeholder="detailColumn" @input="detailColumnVal" name="detailColumnVal"></el-input>
                        </el-form-item>
                </el-form>
        </div>
</template>
