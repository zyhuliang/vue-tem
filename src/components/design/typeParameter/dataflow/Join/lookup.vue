...
<template>
        <div class="stepTable">
                        ...
                        <el-tabs v-model="editableTabsValue" type="card" editable @edit="handleTabsEdit " @tab-click="handleClick">
                                ...
                                <el-tab-pane :key="index" v-for="(item, index) in nodeData.ruleSettings" :label="index | labTabsFilter| cn" :name="index | nameTabsFilter">
                                        <el-form-item label="数据集">
                                                ...
                                                <el-input :placeholder="'（必填）'" :value="nodeData.ruleSettings[index].dataset" @input="(value) => dataSetVal(value, index)" name="dataSetVal">
                                                        <el-button slot="append" icon="icon iconfont icon-ir-search" @click="dataSetInq(index)" name="dataSetInq"></el-button>
                                                </el-input>
                                        </el-form-item>
                                        ...
                                        <el-form-item :label="'inputKeyColumn'| cn">
                                                ...
                                                <el-input  readonly v-model="nodeData.ruleSettings[index].inputKeyColumn"  @focus="getinputKeyColumnData(index)" placeholder="（必填）"> </el-input>
                                        </el-form-item>
                                        ...
                                        <el-form-item :label="'valueColumns'| cn">
                                                ...
                                                <div>
                                                        ...
                                                        <ul class="tableTitle" v-for="(vc,key1) in nodeData.ruleSettings[index].valueColumns" :key="key1">
                                                                <li>
                                                                        <el-tooltip class="item" effect="dark" :content="vc.name == ''?'请点击选择字段':vc.name" placement="top">
                                                                                <el-input  readonly v-model="vc.name"  @focus="getFieldsDialogVisibleData(index,key1)" placeholder="（必填）"> </el-input>
                                                                        </el-tooltip>
                                                                </li>
                                                                 <li>
                                                                        <el-input class="selectClass" :value="vc.alias" :placeholder="'（必填）'" @input="(value) => aliasNameVal(value,index,key1)" name="alias"></el-input>
                                                                </li>
                                
                                                                <li>
                                                                        <el-input class="selectClass" :value="vc.defaultNoMatch" name="defaultNoMatch" :placeholder="'（必填）'" @input="(value) => defaultValueVal(value,index,key1)"></el-input>
                                                                </li>
                                                                <li>
                                                                        <el-input class="selectClass" :value="vc.defaultNullKey" name="defaultNullKey" :placeholder="'（必填）'"  @input="(value) => nullDefaultValueVal(value,index,key1)"></el-input>
                                                                </li>
                ...
                <!-- inputKeyColumn 列名选着弹框 -->
                <el-dialog v-dialog-drag  title="选择内容" :modal="false" :visible.sync="getinputKeyColumnVisible"  @click="designkeyNone"  custom-class="gettFieldsDialog" >
                        <div class="dialog-content">
                                <getFields :getFields = "getFields" @selFieldsVal = "selFieldsVal"></getFields>
                        </div>
                </el-dialog>
                <!-- valueColumns 列名选着弹框 -->
                <el-dialog  v-dialog-drag title="选择内容" :modal="false" :visible.sync="getFieldsDialogVisible"  @click="designSetNone"  custom-class="gettFieldsDialog" >
                        <div class="dialog-content">
                                <getDataset :getdataset = "getdataset" @selDataSet = "selDataSet"></getDataset>
                        </div>
                </el-dialog>
...
<script>
    ...
    import getDataset from '@components/design/designDraw/getDataset.vue';
    ...
    export default  vm = {
        ...
        data() {
            return {
                ...
                getinputKeyColumnVisible: false,
                ruleForm:{
                     name: ''
                },
                 rules: {
        ...
        methods: {
         ...
         //关闭弹框 inputKeyColumn
           designkeyNone(){
                 this.getinputKeyColumnVisible = false;  
           },
           getinputKeyColumnData(index){
                this.newIndex = index
               this.getinputKeyColumnVisible = true
               this.getFields = this.getSelFields[0].fields    
           },
           selFieldsVal(val){
                this.nodeData.ruleSettings[this.newIndex].inputKeyColumn = val
                this.getinputKeyColumnVisible = false;    
           },
           //选择内容弹框 valueColumns
           getFieldsDialogVisibleData(index,index1){
                   this.newIndex = index
                   this.newIndex1  = index1
                   this.getFieldsDialogVisible = true;  
           },
           // valueColumns 组件传值
           selDataSet: function (val) {
                // childValue就是子组件传过来的值
                this.nodeData.ruleSettings[this.newIndex].valueColumns[this.newIndex1].name = val;
           ...
           designSetNone(){                  // 点击取消/关闭按钮
            ...
            handleClick(tab, event) {
                ...
                //datasetIdArr
                this.datasetIdArr = JSON.parse(sessionStorage.getItem("datasetIdArr"))
                console.log(this.datasetIdArr)
                this.getDatasetId((this.datasetIdArr)[tab.index])
            },
            /**
             * 获取子组件的dataSet
             * ------------------------------------------------------------------
            ...
            getSelectDateVal(data){
                this.datasetIdArr = JSON.parse(sessionStorage.getItem("datasetIdArr"))
                this.datasetIdArr[this.dialogIndex] = data.schemaId
                ...
                this.getdataset = data.fields
                sessionStorage.setItem("datasetIdArr",JSON.stringify(this.datasetIdArr))
            },
            /**
        ...
        mounted() {
                ...
                if(idValue.length===0){
                        ...
                        var id = JSON.parse(sessionStorage.getItem("datasetIdArr"))[this.dialogIndex]
