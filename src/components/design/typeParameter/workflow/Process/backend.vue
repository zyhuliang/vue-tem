    ...
    <div>
        <el-form id="bm-nodeset-shell-form" ref="nodeSetData" :model="nodeSetData" label-width="150px">
                <el-form-item :label="'服务类型'">
                        ...
                        <el-select v-model="nodeData.serviceType" placeholder="请选择">
                            <el-option
                ...
                <div v-if="nodeData.serviceType=='count'">
                    ...
                    <el-form-item :label="'数据集'" v-if="nodeData.serviceType=='count'">
                        <el-tooltip lass="item" effect="dark" content="1.数据集名称,从资源目录选择或编辑创建 2.格式为字符串：字符/数字/下划线/-/的组合"
                                    placement="top">
                            <i class="parIcon el-icon-warning"></i>
                        </el-tooltip>
                    ...
                    <el-form-item  :label="'dataset存放位置'" v-if="nodeData.count_type=='ResourceDesc'">
                            <el-input placeholder="默认路径为根目录" v-model="nodeData.count_obj_name" name="dataset存放位置" :disabled="true"
                ...
                <div v-if="nodeData.serviceType=='index'">
                    ...
                    <el-form-item :label="'数据集名称'| cn">
                            <el-tooltip  class="item" effect="dark" :content="'index_dataset_name'" placement="top">
                                    <i class="parIcon el-icon-warning"></i>
                            </el-tooltip>
                            <el-input v-model="nodeData.index_dataset_name" placeholder="（必填）"  name="index_dataset_name"></el-input>
                    </el-form-item>
                    <el-form-item  :label="'数据集id'| cn">
                        <el-tooltip  class="item" effect="dark" :content="'index_dataset_id'| cn" placement="top">
                                <i class="parIcon el-icon-warning"></i>
                        </el-tooltip>
                        <el-input v-model="nodeData.index_dataset_id" placeholder="（必填）"  name="index_dataset_id"></el-input>
                    </el-form-item>
        ...
        methods: {
            ...
            getSelectDateVal(data) {
                ...
                if(this.nodeData.count_type=='Dataset'){
                    ...
                    this.nodeData.count_store_name = data.name
                    this.nodeData.dataset = data.name
                }else if(this.nodeData.serviceType=='index'){
                    if(this.DatasetEs==true){
                        this.nodeData.index_store_name = data.name  //es数据集
                        this.nodeData.index_store_id = data.id
                        this.DatasetEs=false
                    }else {
                        this.nodeData.index_dataset_id = data.id     //hdfs数据集
                        this.nodeData.index_dataset_name = data.name
                        this.nodeData.dataset = data.name
                    }
                ...
                if(this.nodeData.serviceType=='quality'){
