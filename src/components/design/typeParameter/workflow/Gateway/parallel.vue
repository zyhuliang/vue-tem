<!-- steps参数 workFlow Gateway parallel -->
<template>
        <div>
                <el-form id="bm-nodeset-parallel-form" ref="nodeSetData" :model="nodeSetData" label-width="150px">
                        <el-form-item  :label="'conditions'| cn">
                                <el-tooltip  class="item" effect="dark" content="conditions" placement="top">
                                ...
                                <div>
                                        ...
                                        <div class="cdPrompt">提示：并行控制节点，满足条件的所有输出节点都将执行！</div>
                                </div>
