        ...
        <div class="stepTable">
                <el-form id="bm-nodeset-cache-form" ref="nodeSetData" :model="nodeSetData" label-width="150px">
                        <el-form-item :label="nodeData.dataset | dataSetNameFilter | cn">
                                ...
                                <el-input placeholder="（必填）" :value="nodeData.dataset" @input="dataSetVal">
                        ...
                        <el-form-item :label="'schema'|cn">
                                ...
                                <el-input placeholder="（必填）" :value="nodeData.schema" :disabled = "dataSelValDis" @input="schemaVal">
                        ...
                        <el-form-item :label="'keyColumn'| cn">
                                ...
                                <el-select class="selectClass" :value="nodeData.keyColumn" placeholder="（必填）" @change="keyColumnSelect">
                                        <div v-if="getSelFields.length!=0">
                        ...
                        <el-form-item :label="'valueColumns'| cn">
                                ...
                                <el-select class="selectClass" multiple filterable allow-create  default-first-option :value="nodeData.valueColumns" placeholder="（必填，多选）" @change="valueColumnsSelect">
                        ...
                        <el-form-item :label="'path'| cn" v-if="nodeData.engine != 'REDIS' && nodeData.engine != 'IGNITE'">
                                ...
                                <el-input :value="nodeData.path" placeholder="（必填）" @chainputnge="pathVal"></el-input>
                        </el-form-item>
                        <!--{{nodeData.path}}-->
                        ...
                        <el-form-item :label="'url'| cn" v-if="nodeData.engine == 'REDIS' || nodeData.engine == 'IGNITE'">
                                ...
                                <el-input :value="nodeData.url" placeholder="（必填）" @input="urlVal"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item :label="'key'| cn" v-if="nodeData.engine == 'REDIS'">
                                ...
                                <el-input placeholder="（必填）" :value="nodeData.key" @input="keyVal">
                                        <el-button slot="append" icon="icon fa fa-random" @click="keyRandomUuid"></el-button>
                                </el-input>
                        </el-form-item>
                        <el-form-item :label="'password'| cn"  v-if="nodeData.engine == 'REDIS'">
                                ...
                                <el-input type="password" auto-complete="new-password" :value="nodeData.password" placeholder="password" @input="passwordVal"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item :label="'cacheName'| cn" v-if="nodeData.engine == 'IGNITE'">
                                ...
                                <el-input placeholder="（必填）" :value="nodeData.cacheName" @input="cacheNameVal">
                                        <el-button slot="append" icon="icon fa fa-random" @click="cacheNameRandomUuid"></el-button>
                                </el-input>
                        </el-form-item>

                </el-form> <!-- 数据集查询 dialog-->
